...
boss@boss:~/Documents/lab/java$ java ElectBill
...
**boss@boss:~/Documents/lab/java$ java Convertor**
...
boss@boss:~/Documents/lab/java$ java Shapes
Enter values : 
7 
8
...
boss@boss:~/Documents/lab/java$ java StackADT 
...
┌──(boss㉿boss)-[~/javalab] └─$ java WrapperClassDemo
...
(boss㉿boss)-[~/javalab] └─$ java ThreadProgram
...
──(boss㉿boss)-[~/javalab] └─$ java FileDemo
...
──(boss㉿boss)-[~/javalab] └─$ java reservation
